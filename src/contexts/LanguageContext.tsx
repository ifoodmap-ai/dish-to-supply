...
const translations = {
  en: {
    ...
    'auth.forgotPasswordDesc': 'Please contact support to reset your password',
  ...
  zh: {
    ...
    'auth.email': '電子郵件',
    'auth.emailLogin': '郵件登入',
    'auth.phone': '手機號碼',
    'auth.phoneLogin': '手機登入',
    ...
    'auth.rememberMe': '記住帳號',
    'auth.forgotPassword': '忘記密碼',
    'auth.forgotPasswordDesc': '請聯絡客服重設密碼',
    'auth.quickLogin': '快速登入',
    'auth.loading': '載入中...',
