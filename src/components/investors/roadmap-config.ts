...
export const FALLBACK_FEATURES: RoadmapFeature[] = [
  ...
  fb(11, 'procurement', 1, '分析紀錄後台管理', '所有 AI 分析需求集中列表、狀態分類與追蹤', 'done', 1, '/roadmap/admin-analyses.png'),
  fb(12, 'procurement', 1, '需求審核流程', '管理員審核 AI 分析結果,一鍵批准發送或拒絕', 'done', 2, '/roadmap/analysis-detail.png'),
  fb(13, 'procurement', 1, '完整對話紀錄檢視', '聊天室式圖文穿插紀錄,圖片燈箱放大檢視', 'done', 3, '/roadmap/analysis-detail.png'),
  fb(14, 'procurement', 1, '買家聯絡資訊管理', '訂單與分析詳情整合買家聯絡方式,方便跟進', 'done', 4, '/roadmap/analysis-detail.png'),
  fb(15, 'procurement', 2, '供應商訂單建立與發送', '審核通過即自動建立訂單並推送給對應供應商', 'done', 5, '/roadmap/admin-orders.png'),
  fb(16, 'procurement', 2, '訂單列表/明細/搜尋', '訂單全生命週期管理,支援搜尋與明細檢視', 'done', 6, '/roadmap/admin-orders.png'),
  fb(17, 'procurement', 3, '線上報價回覆', '供應商線上回報價格,買家即時比較確認', 'done', 7, '/roadmap/feat-quotes.png'),
  fb(18, 'procurement', 3, '下單與付款金流', '線上下單、金流串接與交易保障(沙盒示範版已完成,實際上線待串接金流商)', 'in_progress', 8, '/roadmap/feat-billing.png'),
  fb(19, 'procurement', 4, '對帳與電子發票', '自動對帳結算、電子發票開立(沙盒示範版已完成,實際上線待串接發票商)', 'in_progress', 9, '/roadmap/feat-billing.png'),
  fb(20, 'procurement', 4, '營運數據儀表板', 'GMV、媒合率、回購率等核心指標即時儀表板', 'done', 10, '/roadmap/admin-dashboard.png'),
  fb(21, 'supplier_portal', 1, 'Email＋密碼會員認證', '安全的帳號註冊、登入與權限控管', 'done', 1, '/roadmap/auth.png'),
  fb(22, 'supplier_portal', 1, '角色導向登入', '管理員/供應商登入後自動導向各自專屬後台', 'done', 2, '/roadmap/auth.png'),
  fb(23, 'supplier_portal', 2, '供應商接單列表', '供應商專屬入口,即時查看平台派發的新訂單', 'done', 3, '/roadmap/supplier-orders.png'),
  fb(24, 'supplier_portal', 2, '確認出貨流程', '一鍵確認出貨並回報平台,流程透明', 'done', 4, '/roadmap/supplier-orders.png'),
  fb(25, 'supplier_portal', 2, '出貨紀錄查詢', '歷史出貨紀錄與追蹤資訊完整保存', 'done', 5, '/roadmap/supplier-shipments.png'),
  fb(26, 'supplier_portal', 3, '供應商商品目錄管理', '供應商自主上架、管理商品品項與價格', 'done', 6, '/roadmap/supplier-catalog.png'),
  fb(27, 'supplier_portal', 3, '物流追蹤', '出貨後物流狀態即時追蹤與異常提醒', 'done', 7, '/roadmap/feat-logistics.png'),
  fb(28, 'supplier_portal', 4, 'LINE 即時通知', '新訂單、出貨提醒即時 LINE 推播(沙盒示範版已完成,實際上線待 LINE 官方帳號串接)', 'in_progress', 8, '/roadmap/feat-notifications.png'),
  fb(29, 'supplier_portal', 4, '供應商評價系統', '買家評價供應商,建立平台信任機制', 'done', 9, '/roadmap/supplier-reviews.png'),
];
